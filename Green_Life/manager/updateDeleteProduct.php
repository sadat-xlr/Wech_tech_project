            ...
            <fieldset>
                <form action="" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="<?php echo $product["category"]; ?>" placeholder="Category Name" name="newCategory"> 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="<?php echo $product["product"]; ?>" placeholder="New Product Name" name="newProduct"> 
