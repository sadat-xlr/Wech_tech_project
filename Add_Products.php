     ...
     <div class="row">
	    <div class="col-2">
		 ...
		 <div class="col-2">
			...
			<p style="color:red"><?php echo $err_price; ?></p>
			<input type="text" placeholder="short discription" name="shortdes">
			<p style="color:red"><?php echo $err_shortdes; ?></p>
			...
			<p style="color:red"><?php echo $err_category; ?></p>
				...
				<button type="submit" class="btn" value="Addproduct">Add</button>
